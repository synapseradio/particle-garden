...
Span, live fraction, and cliff per declared slice, at the calibrated thresholds SPAN_MIN=0.15, LIVE_FRACTION_MIN=0.7, CLIFF_MAX=0.25, RESPONSE_EPSILON=0.0001 (src/ui/api/response_probe.nim records the calibration beside each constant). Regenerated by tests/test_response_probe.nim; edits here are overwritten.
