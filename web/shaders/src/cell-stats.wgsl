...
// =============================================================================
//
// NOTE: This shader uses SoA (Struct of Arrays) layout, unlike the rest of the
// codebase which uses AoS. It's preserved for potential LOD optimization but
// is not currently active in the main pipeline.
//
...
// Particle data (SoA layout - separate arrays for each field)
