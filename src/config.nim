...
# generated by palette.generatePalette using the default golden-ratio hue
# spacing. See palette.nim for the generator; MAX_SPECIES is defined in
# memory_layout.nim (the AoS/matrix contract) and re-exported above.

var COLORS* {.exportc.}: Float32Array =
  newFloat32Array(flattenPalette(generatePalette(MAX_SPECIES)))
